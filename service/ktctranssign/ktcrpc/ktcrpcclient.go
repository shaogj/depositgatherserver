...
func Getnewaddress() string {
	//4API
   response, err := KTCRPCClient.RpcClient.Call("getnewaddress","")
...
func GetAddprivkey(addr string) string {
    ...
    response, err := KTCRPCClient.RpcClient.Call("dumpprivkey",addr)
...
func GetInfo() string {
	//4API
   response, err := KTCRPCClient.RpcClient.Call("getinfo","")
...
func GetAccountAddress(account string) (string, error) {
    //sg 0814 add:
    response, err := KTCRPCClient.RpcClient.Call("getaccountaddress", []interface{}{"product.1"})
...
func CreateTransaction(createtxstr []string,addr string) (curinfo interface{},err error) {
    ...
    response, err := KTCRPCClient.RpcClient.Call("createrawtransaction",createtxstr,addr)
